  ...
  return (
    <section className="p-4 md:p-16">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-extrabold text-primary-content text-center mb-8">
          We've helped thousands of sales teams
        </h2>

        <Marquee gradient={false} speed={50} direction="left">
          {brandLogos.map((logo, index) => (
            <div key={index} className="mx-8 mb-8">
              <img
                src={logo}
                alt={`Brand ${index + 1}`}
        ...
        <div className="border-t-[2px] border-dashed border-gray-400 my-8"></div>
      </div>
    </section>
  );
};
